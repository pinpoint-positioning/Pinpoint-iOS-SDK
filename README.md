...
3. In Xcode -> *Add Package Dependencies* -> Enter `pinpoint.pinpointsdk` -> Add to Project

<img src="images/xcode-add-package.png" alt="Routing Solution" width="600"/> 
...
In our [Sample App]("https://github.com/pinpoint-positioning/Pinpoint-iOS-SDK/tree/main/PinpointSampleApp"), the blob will be added via a simple file picker.
...
The included [Sample App]("https://github.com/pinpoint-positioning/Pinpoint-iOS-SDK/tree/main/PinpointSampleApp") shows a minimal implementation of the **LiveActivity** with continuous background positioning.
